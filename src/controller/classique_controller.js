...
exports.createData = (request, response) =>{
    ...
    fs.readFile(pathToData, (err, data) =>{
        ...
        existingData.classique.push(request.body);
...
exports.getClassique = (request, response) =>{
    ...
    // Sinon renvoi status 200 et le rendre en format json
                ...
                const existingData = JSON.parse(data).classique
...
exports.getDataById = (request, response) =>{
    ...
    fs.readFile(pathToData, (err, data) =>{
        ...
        if(err){
            ...
            const dataId = manipData.classique.find(
...
exports.updateData = (request, response) =>{
    ...
    fs.readFile(pathToData, (err,data) =>{
        ...
        const dataId = existingData.classique.find(
        (obj) => obj.id === parseInt(request.params.id)    
        );
...
exports.deleteDataById = (request, response) => {
    ...
    if (err) {
        ...
        if (!dataId) {
            ...
            existingData.classique = existingData.classique.filter(
                (obj) => obj.id != parseInt(request.params.id));
