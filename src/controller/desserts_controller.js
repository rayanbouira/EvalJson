...
exports.createData = (request, response) =>{
    ...
    fs.readFile(pathToData, (err, data) =>{
        ...
        existingData.desserts.push(request.body);
...
exports.getDesserts = (request, response) =>{
...
exports.getDataById = (request, response) =>{
    ...
    fs.readFile(pathToData, (err, data) =>{
        ...
        if(err){
            ...
            const dataId = manipData.desserts.find(
...
exports.updateData = (request, response) =>{
    ...
    fs.readFile(pathToData, (err,data) =>{
        ...
        const dataId = existingData.desserts.find(
        (obj) => obj.id === parseInt(request.params.id)    
        );
...
exports.deleteDataById = (request, response) => {
    ...
    if (err) {
        ...
        if (!dataId) {
            ...
            existingData.desserts = existingData.desserts.filter(
                (obj) => obj.id != parseInt(request.params.id));
